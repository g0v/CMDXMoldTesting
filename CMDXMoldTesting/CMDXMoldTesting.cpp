...
// CMDXMoldTesting.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CCMDXMoldTestingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CCMDXMoldTestingApp construction

CCMDXMoldTestingApp::CCMDXMoldTestingApp()
{
...
// The one and only CCMDXMoldTestingApp object

CCMDXMoldTestingApp theApp;


// CCMDXMoldTestingApp initialization

BOOL CCMDXMoldTestingApp::InitInstance()
{
